"""
Component Contract for test_claude_adapter
Definition: Unit tests for the claude_adapter integration.
Responsibility: Verify idempotent generation and merging of MCP server config for Claude Desktop.
...
Connections: Tests integrations.claude_adapter.
"""
import json
import os
import tempfile
...
from integrations.claude_adapter import merge_claude_config
...
def test_generate_new_config(temp_config_file):
    ...
    merge_claude_config(temp_config_file, repo_path)
